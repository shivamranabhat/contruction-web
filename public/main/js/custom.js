...
// Mobile Navigation
const header = document.querySelector("header.construct.header-curvy");

    // Check if the element exists
    if (header) {
        // Function to handle the scroll and width logic
        function handleScroll() {
            if (window.innerWidth < 991) {
                if (window.scrollY > 0) {
                    ...
                    header.style.position = ""; // Reset the style
                    header.style.top = "";
                }
            } else {
                // Reset styles if the width is greater than or equal to 991px
        ...
        // Initial check to ensure correct styles on page load
        handleScroll();
    }
