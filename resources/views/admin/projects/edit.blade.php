                            ...
                            <form method="POST" action="{{ route('project.update',$project->slug) }}"
                                ...
                                <div class="form-outline mb-3">
                                    ...
                                    <select
                                        ...
                                        <option value="{{$project->project_category_id}}">{{ $project->category->name }}
                                        </option>
                                ...
                                <div class="row align-items-end">
                                    <div class="image-area"><img id="imageResult"
                                            src="{{asset('storage/'.$project->image)}}" width="150"></div>
                                ...
                                <div class="form-outline mb-3">
                                    ...
                                    <textarea name="description" id="description"
                                        class="form-control @error('description') is-invalid @enderror {{ $errors->has('description') ? 'error' : '' }}">{{ $project->description }}</textarea>
                                    @error('description')
                                    <span class="text-danger">{{$message}}</span>
                                    @enderror
                                </div>
