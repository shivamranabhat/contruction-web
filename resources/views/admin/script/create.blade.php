                        ...
                        <div class="card-body mt-2">
                            <form method="POST" action="{{ route('script.store') }}">
                                ...
                                <div class="form-outline mb-4">
                                    ...
                                    <select
                                        class="form-select @error('position') is-invalid @enderror {{ $errors->has('position') ? 'error' : '' }}"
                                        name="position" id="position" role="button">
                                ...
                                <div class="form-outline my-4">
                                    ...
                                    <textarea
                                        class="form-control @error('code') is-invalid @enderror {{ $errors->has('code') ? 'error' : '' }}"
                                        id="code" name="code" rows="2" required>{{ old('code') }}</textarea>
