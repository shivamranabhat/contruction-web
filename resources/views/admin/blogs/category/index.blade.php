                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-12 col-md-6 col-lg-6 px-0">
                                        <div class="dataTables_length d-flex justify-content-end mt-3 mt-lg-0 mt-xl-0 px-0" id="datatable_length">
                                            <a href="{{route('blogCategory.create')}}" class="text-center btn btn-primary btn-icon mt-lg-0 mt-md-0 mt-3">
                                                <i class="btn-inner">
                                                ...
                                                <td>
                                                    <div class="flex align-items-center list-user-action">
                                                        <a class="btn btn-sm btn-icon btn-warning"
                                                            ...
                                                            data-original-title="Edit" href="{{route('blogCategory.edit', $category->slug)}}" aria-label="Edit"
                                                        ...
                                                        <form id="delete-form-{{$category->slug}}" action="{{route('blogCategory.destroy', $category->slug)}}" method="POST" style="display:none;">
                                                            @csrf
                                                            @method('DELETE')
                                                        </form>
                                                    </div>
