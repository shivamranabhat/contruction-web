                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body mt-2">
                            <form method="POST" action="{{ route('whyUs.update',$details->slug) }}"
                                ...
                                <div class="form-outline mb-3">
                                    ...
                                    <textarea name="description" id="description"
                                        class="form-control @error('description') is-invalid @enderror {{ $errors->has('description') ? 'error' : '' }}" rows="1">{{ $details->description }}</textarea>
                                    @error('desscription')
                                    <span class="text-danger">{{$message}}</span>
                                    @enderror
                                </div>
