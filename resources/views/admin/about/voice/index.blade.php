                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <div class="dataTables_length d-flex justify-content-end mt-3 mt-lg-0 mt-xl-0 px-0" id="datatable_length">
                            <a href="{{route('voice.create')}}" class=" text-center btn btn-primary btn-icon mt-lg-0 mt-md-0 mt-3">
                                <i class="btn-inner">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <div id="datatable_wrapper" class="dataTables_wrapper dt-bootstrap5">
                                                ...
                                                <td>
                                                    <div class="flex align-items-center list-user-action">
                                                        <a class="btn btn-sm btn-icon btn-warning"
                                                            ...
                                                            data-original-title="Edit" href="{{route('voice.edit',$voice->slug)}}" aria-label="Edit"
                                                        ...
                                                        <a class="btn btn-sm btn-icon btn-danger" type="button" data-toggle="modal" data-target="#delete_{{$voice->slug }}" data-bs-original-title="Delete">
                                                            <span class="btn-inner">
                                                                <svg class="icon-20" width="20" viewBox="0 0 24 24"
                                                                    fill="none" xmlns="http://www.w3.org/2000/svg"
                                                                    stroke="currentColor">
                                                        ...
                                                        <!-- Modal -->
                                                        <div class="modal fade" id="delete_{{$voice->slug }}" tabindex="-1" role="dialog"
                                                            ...
                                                            <div class="modal-dialog modal-dialog-centered"
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer justify-content-center">
                                                                        ...
                                                                        <form
                                                                            action="{{ route('voice.destroy', $voice->slug) }}"
                                                                            method="POST">
                                                                            @csrf
                                                                            @method('DELETE')
                                                                            <button type="submit"
                                ...
                                {{ $voices->links('vendor.pagination.simple-tailwind') }}
                                <div class="clear"></div>
                            </div>
                        </div>
                    </div>
