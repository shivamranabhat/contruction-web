                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <div class="back">
                                <a href="{{route('achievements')}}" class=" text-center btn btn-primary btn-icon mt-lg-0 mt-md-0 mt-3">
                                    <i class="btn-inner">
                        ...
                        <div class="card-body mt-2">
                            <form  method="POST" action="{{ route('achievement.update',$achievement->slug) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="form-outline mb-3">
                                    <div class="image-area"><img id="imageResult" src="{{ asset('storage/' . $achievement->image) }}"
                                        width="80"></div>
