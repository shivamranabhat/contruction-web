                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <div id="datatable_wrapper" class="dataTables_wrapper dt-bootstrap5">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-12 col-md-6 col-lg-6 px-0">
                                        <div class="dataTables_length d-flex justify-content-end mt-3 mt-lg-0 mt-xl-0 px-0" id="datatable_length">
                                            <a href="{{route('graph.create')}}" class=" text-center btn btn-primary btn-icon mt-lg-0 mt-md-0 mt-3">
                                                <i class="btn-inner">
                                    ...
                                    <table class="table dataTable" aria-describedby="datatable_info">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-capitalize">{{ $graph->tag_name ?? '' }}</td>
                                                <td class="text-capitalize">{{ $graph->page->name }}</td>
                                                <td>{{ $graph->created_at }}</td>
                                                <td>
                                                    <div class="flex align-items-center list-user-action">
                                                        <a class="btn btn-sm btn-icon btn-warning"
                                                            data-bs-toggle="tooltip" data-bs-placement="top"
                                                            data-original-title="Edit" href="{{route('graph.edit',$graph->slug)}}" aria-label="Edit"
                                                        ...
                                                        <a class="btn btn-sm btn-icon btn-danger" type="button" data-toggle="modal" data-target="#delete_{{ $graph->slug }}" data-bs-original-title="Delete">
                                                            <span class="btn-inner">
                                                                <svg class="icon-20" width="20" viewBox="0 0 24 24"
                                                                    fill="none" xmlns="http://www.w3.org/2000/svg"
                                                                    stroke="currentColor">
                                                        ...
                                                        <!-- Modal -->
                                                        <div class="modal fade" id="delete_{{ $graph->slug }}" tabindex="-1" role="dialog"
                                                            ...
                                                            <div class="modal-dialog modal-dialog-centered"
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer justify-content-center">
                                                                        ...
                                                                        <form
                                                                            action="{{ route('graph.destroy', $graph->slug) }}"
                                                                            method="POST">
                                                                            @csrf
                                                                            @method('DELETE')
                                                                            <button type="submit"
                                ...
                                {{ $graphs->links('vendor.pagination.simple-tailwind') }}
                                <div class="clear"></div>
                            </div>
                        </div>
                    </div>
