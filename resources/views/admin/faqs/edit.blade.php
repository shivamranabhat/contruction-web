                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body mt-2">
                            <form method="POST" action="{{ route('faq.update',$faq->slug) }}"
                                ...
                                <div class="form-outline mb-3">
                                    ...
                                    <textarea name="description" id="description"
                                        class="form-control @error('description') is-invalid @enderror {{ $errors->has('description') ? 'error' : '' }}">{{ $faq->description }}</textarea>
                                    @error('description')
                                    <span class="text-danger">{{$message}}</span>
                                    @enderror
                                </div>
